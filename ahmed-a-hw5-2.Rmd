...
modelsummary(list("DD" = m.dd),
             ...
             gof_map=NA, coef_omit='Intercept',
             output = "kableExtra") %>%
  kable_styling(latex_options = c("hold_position"))
```
...
modelsummary(list("DD" = mod.twfe2),
             title = "Effect of Medicaid Expansion on Uninsurance Rate",
             gof_map=NA, coef_omit='Intercept',
             output = "kableExtra") %>%
  kable_styling(latex_options = c("hold_position"))
...
```{r fig9, include=T, eval=T, echo=F, fig.cap="Effect of Medicaid Expansion"}
iplot(mod.twfe, 
...
```{r fig10, include=T, eval=T, echo=F, fig.cap="Effect of Medicaid Expansion"}
iplot(mod.twfe2, 
      xlab = 'Time to treatment',
      main = 'Event study')
```
